...
#合法
with open('legit_evidence_specificity_record.txt', 'r', encoding='utf-8') as f:
    content = f.read()
...
#合法：543组Claim_Evidence
#0.7 0.6370165745856353 0.0 0.9



#非法
with open('fraud_evidence_specificity_record.txt', 'r', encoding='utf-8') as file:
    content_f = file.read()
...
#非法：772组Claim_Evidence
#0.5 0.5082901554404144 0.1 0.9